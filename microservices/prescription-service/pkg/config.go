...
func (c PrescriptionServiceConfig) MongoURI() string {
	return fmt.Sprintf(
...
func LoadConfig() (*PrescriptionServiceConfig, error) {
	v := viper.New()

	v.SetEnvPrefix("PRESCRIPTIONSERVICE")
	...
	var cfg PrescriptionServiceConfig
	err := v.Unmarshal(&cfg)
	if err != nil {
