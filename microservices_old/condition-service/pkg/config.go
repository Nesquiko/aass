...
type ConditionsServiceConfig struct {
	App struct {
...
func (c ConditionsServiceConfig) MongoURI() string {
	return fmt.Sprintf(
...
func LoadConfig() (*ConditionsServiceConfig, error) {
	v := viper.New()

	v.SetEnvPrefix("CONDITIONSERVICE")
	...
	var cfg ConditionsServiceConfig
	err := v.Unmarshal(&cfg)
	if err != nil {
